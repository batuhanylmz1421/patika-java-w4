...
public class Hotel {
    ...
    int id, star, phoneNum;

    public Hotel(String name, String address, String mail, String location, String facilityFeatures, String hostelType, int id, int star, int phoneNum) {
        this.name = name;
